<x-layout title="Projects">
    ...
    <div
      ...
      reset() {
        ...
        :class="{'pt-24': !@js(auth()->check() && auth()->user()->role === 'admin')}"
    >

        {{-- FILTERS --}}
        <section class="max-w-7xl mx-auto px-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12 mt-24">
            {{-- Search --}}
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-6">
                ...
                <div class="relative">
                   ...
                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                    <span
                        class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 pointer-events-none">🔍</span>
                </div>
            </div>
        ...
        <section class="max-w-7xl mx-auto px-6 grid gap-12 md:grid-cols-2 lg:grid-cols-3 pb-16">
            @forelse($projects as $project)
                <div
                    class="group relative overflow-visible bg-white dark:bg-gray-800 rounded-2xl shadow-lg flex flex-col">
                    {{-- Avatar Bubble --}}
                    <div
              ...
              {{ $tag->name }}
                        ...
                        <div class="flex gap-4 mt-auto">
                            <a href="{{ $project->link }}"
                               class="@if(auth()->check() && auth()->user()->role === 'admin') flex-1 @else w-full @endif">
