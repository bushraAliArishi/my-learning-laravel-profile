...
>
    ...
    {{-- Mobile menu --}}
    <div id="links-mobile"
         class="md:hidden hidden flex-col gap-3 px-6 pb-4 bg-white shadow-md border-t border-gray-200">
        <x-nav-link href="/" :active="request()->is('/')">Home</x-nav-link>
        <x-nav-link href="/projects" :active="request()->is('projects*')">Projects</x-nav-link>
        <x-nav-link href="/experience" :active="request()->is('experience*')">Experience</x-nav-link>
...
@if((request()->routeIs('projects.index') || request()->routeIs('experience.index'))
    ...
    <header class="container mx-auto w-full pt-24 rounded-lg relative">
        <div class="sm:flex sm:justify-between inset-0 gap-3 mx-auto">
