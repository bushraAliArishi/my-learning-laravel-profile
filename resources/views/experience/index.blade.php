      ...
      <div class="relative max-w-2xl mx-auto">
        ...
        @foreach($experiences as $exp)
          <div class="relative mb-16 flex items-start">
            ...
            {{-- <!-- النقطة متصلة بالبطاقة -->
            <div class="absolute top-8 w-4 h-4 bg-blue-600 rounded-full border-4 border-white
                        @if($loop->iteration % 2 === 0)
                          left-1/2 transform -translate-x-1  <!-- النقطة بجانب البطاقة الزوجية -->
                        @else
                          left-1/2 transform -translate-x-1  <!-- النقطة بجانب البطاقة الفردية -->
                        @endif"></div> --}}
          </div>
        @endforeach
      </div>
