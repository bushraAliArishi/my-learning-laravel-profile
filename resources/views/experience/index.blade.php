  ...
  <section class="py-16 bg-gray-50 dark:bg-gray-900">
    <div class="mx-auto max-w-4xl px-6 space-y-8">
      ...
      @foreach($experiences as $exp)
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col sm:flex-row sm:justify-between sm:items-start">
          ...
          <div class="mt-6 sm:mt-0 sm:ml-6 flex gap-4">
            <a href="{{ route('experience.show', $exp->id) }}" class=" block">
              <x-button variant="gradient"  size="lg">
                View
              </x-button>
            </a>
            <a href="{{ route('experience.edit', $exp->id) }}" class=" block">
